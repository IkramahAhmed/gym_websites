...
const Detail = ({exerciseDetail}) => {
    const{bodyPart,gifUrl,name,target,equipment}=exerciseDetail;//object destructring hoe he {} is kay andar
  ...
  const extraDetail=[
    ...
    return (
  <Stack  gap="60px" sx={{flexDirection:{lg:'row'},p:'20px', margin:'45px',alighItems:'center'}}>
<img src={gifUrl} alt={name} loading="lazy" clasName="detail-image" width="600px"></img>
